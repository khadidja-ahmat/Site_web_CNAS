...
<section id="about">
        ...
        <div class="container my-5">
            ...
            <form method="POST" action="{{route('admin.presidents.store')}}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="description" class="form-control" id="description" max-length="50" placeholder="entrer la description" required>
                </div>
